...
- Snapshots: fn12_1_washingtonpost.com.txt, fn12_2_opensecrets.org.txt
- ✅ Zahl 277 Mio. [PRESENT]: gefunden ['277'], fehlt []
...
## fn18 [ZAHL] — 25 % einheitlicher Steuersatz

- Snapshots: fn18_1_cms.gruene.de.txt
- ✅ Zahl 25 % [PRESENT]: gefunden ['25'], fehlt []

## fn18 [AUSSAGE] — Die meisten Menschen zahlen durch den hohen Freibetrag gar keine Erbschaftsteuer.

- Snapshots: fn18_1_cms.gruene.de.txt

## fn18 [ZAHL] — Formel: Steuer = (Gesamterbe − Lebensfreibetrag) × 25 %

- Snapshots: fn18_1_cms.gruene.de.txt
- ✅ Zahl 25 % [PRESENT]: gefunden ['25'], fehlt []

## fn18 [AUSSAGE] — Hoher Freibetrag pro Person (lebenslang)
...
## fn18 [ZITAT] — Wer „Omas Häuschen" erbt und selbst darin wohnt, bleibt weiterhin geschützt.

- Snapshots: fn18_1_cms.gruene.de.txt
- ❌ Zitat (38%, NOT_FOUND): „Omas Häuschen“
    - längster Treffer: …schen…

## fn19 [ZITAT] — Wer „Omas Häuschen" erbt und selbst darin wohnt, bleibt weiterhin geschützt.

- Snapshots: fn19_1_gruene_bundestag.de.txt
- ✅ Zitat (100%, VERBATIM): „Omas Häuschen“

## fn20 [ZAHL] — Allein die Abschaffung der Privilegien über 26 Mio. € hätte 2023 rund 2 Mrd. € mehr eingebracht.

- Snapshots: fn20_1_gruene_bundestag.de.txt
- ✅ Zahl 26 Mio. [PRESENT]: gefunden ['26'], fehlt []
- ✅ Zahl 2 Mrd. [PRESENT]: gefunden ['2'], fehlt []

## fn20 [AUSSAGE] — Betriebsvermögen erhält Begünstigungen zum Schutz von Investitionen.

- Snapshots: fn20_1_gruene_bundestag.de.txt

## fn20 [ZAHL] — Privilegien für Konzern-Erb\*innen über 26 Mio. € werden abgeschafft — mit Stundungsmodellen für Liquidität.

- Snapshots: fn20_1_gruene_bundestag.de.txt
- ✅ Zahl 26 Mio. [PRESENT]: gefunden ['26'], fehlt []

## fn20 [AUSSAGE] — Privilegien für große Immobilienbestände (über 300 Wohnungen) werden ebenfalls gestrichen.

- Snapshots: fn20_1_gruene_bundestag.de.txt

## fn21 [ZAHL] — 1 % / Jahr Steuersatz

- Snapshots: fn21_1_cms.gruene.de.txt
- ✅ Zahl 1 % [PRESENT]: gefunden ['1'], fehlt []

## fn21 [ZAHL] — Ab 2 Mio. € Freibetrag pro Person

- Snapshots: fn21_1_cms.gruene.de.txt
- ✅ Zahl 2 Mio. [PRESENT]: gefunden ['2'], fehlt []

## fn21 [AUSSAGE] — Betriebsvermögen erhält Begünstigungen zum Schutz von Investitionen.

- Snapshots: fn21_1_cms.gruene.de.txt

## fn21 [AUSSAGE] — Ein durchschnittliches Eigenheim führt nicht zum Anfall dieser Steuer.

- Snapshots: fn21_1_cms.gruene.de.txt

## fn21 [AUSSAGE] — Wird als Ländersteuer erhoben.

- Snapshots: fn21_1_cms.gruene.de.txt

## fn22 [ZAHL] — Gabriel Zucman (UC Berkeley) schlägt global 2 % auf Vermögen über 1 Mrd. USD vor — geschätztes Aufkommen: 200–250 Mrd. USD jährlich.

- Snapshots: fn22_1_gabriel_zucman.eu.txt, fn22_2_icij.org.txt
- ✅ Zahl 2 % [PRESENT]: gefunden ['2'], fehlt []
- ✅ Zahl 1 Mrd. [PRESENT]: gefunden ['1'], fehlt []
- ✅ Zahl 200–250 Mrd. [PRESENT]: gefunden ['200', '250'], fehlt []

## fn23 [ZAHL] — Stefan Bach (DIW) berechnet bis zu 147 Mrd. € jährliches Aufkommen bei einer progressiven Vermögensteuer ab 2,3 Mio. €.

- Snapshots: fn23_1_handelsblatt.com.txt
- ✅ Zahl 147 Mrd. [PRESENT]: gefunden ['147'], fehlt []
- ✅ Zahl 2,3 Mio. [PRESENT]: gefunden ['2,3'], fehlt []

## fn24 [ZITAT] — „Kaum ein Land besteuert Arbeit so hoch und Vermögen so niedrig wie Deutschland." — Marcel Fratzscher, DIW-Präsident

- Snapshots: fn24_1_tagesspiegel.de.txt, fn24_2_diw.de.txt
...
## fn25 [AUSSAGE] — Mehreinnahmen in zweistelliger Milliardenhöhe durch Schließung von Steuerlücken

- Snapshots: fn25_1_finanzwende.de.txt

## fn26 [ZAHL] — Globale Milliardärssteuer könnte für Deutschland ca. 5,7 Mrd. € einbringen

- Snapshots: fn26_1_taxobservatory.eu.txt
